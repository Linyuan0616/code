!
    function(e, t) {
        ...
        function f(e, t, n) {
            ...
            if ("string" == typeof t) {
                ...
                if (Re.test(t)) return se.filter(t, r, !n);
                t = se.filter(t, r)
            }
            return se.grep(e,
                function(e) {
        ...
        function S(e) {
            var t = V,
                n = vt[e];
            return n || ("none" !== (n = A(e, t)) && n || (st = (st || se("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t.documentElement), (t = (st[0].contentWindow || st[0].contentDocument).document).write("<!doctype html><html><body>"), t.close(), n = A(e, t), st.detach()), vt[e] = n),
                n
        }
        function A(e, t) {
        ...
        function M(e, t) {
            ...
            for (; r = u[++s];) if ("*" !== r) {
                if ("*" !== l && l !== r) {
                    if (! (i = a[l + " " + r] || a["* " + r])) for (n in a) if ((o = n.split(" "))[1] === r && (i = a[l + " " + o[0]] || a["* " + o[0]])) { ! 0 === i ? i = a[n] : !0 !== a[n] && (r = o[0], u.splice(s--, 0, r));
                        break
                    }
        ...
        function $(e, t, n) {
            var r, i, o = 0,
                ...
                u = function() {
                    if (i) return ! 1;
                    for (var t = Jt || O(), n = Math.max(0, l.startTime + l.duration - t), r = 1 - (n / l.duration || 0), o = 0, a = l.tweens.length; a > o; o++) l.tweens[o].run(r);
                ...
                c = l.props;
            for (P(c, l.opts.specialEasing); a > o; o++) if (r = en[o].call(l, e, c, l.opts)) return r;
            return B(l, c),
        ...
        var z, X, U = typeof t,
            ...
            xe = function(e) { (V.addEventListener || "load" === e.type || "complete" === V.readyState) && (Te(), se.ready())
            },
            Te = function() {
        ...
        se.fn = se.prototype = {
            ...
            se.extend = se.fn.extend = function() {
                ...
                for ("boolean" == typeof s && (c = s, s = arguments[1] || {},
                    u = 2), "object" == typeof s || se.isFunction(s) || (s = {}), l === u && (s = this, --u); l > u; u++) if (null != (o = arguments[u])) for (i in o) e = s[i],
                    r = o[i],
                s !== r && (c && r && (se.isPlainObject(r) || (n = se.isArray(r))) ? (n ? (n = !1, a = e && se.isArray(e) ? e: []) : a = e && se.isPlainObject(e) ? e: {},
            ...
            se.extend({
                ...
                ready: function(e) {
                    if (!0 === e ? !--se.readyWait: !se.isReady) {
                        ...
                        se.isReady = !0,
                        !0 !== e && --se.readyWait > 0 || (z.resolveWith(V, [se]), se.fn.trigger && se(V).trigger("ready").off("ready"))
                    }
                },
                ...
                map: function(e, t, r) {
                    var i, o = 0,
                        a = e.length,
                        s = [];
                    if (n(e)) for (; a > o; o++) null != (i = t(e[o], o, r)) && (s[s.length] = i);
                ...
                proxy: function(e, n) {
                    ...
                    return "string" == typeof n && (o = e[n], n = e, e = o),
                        se.isFunction(e) ? (r = ne.call(arguments, 2), i = function() {
            ...
            se.ready.promise = function(t) {
                if (!z) if (z = se.Deferred(), "complete" === V.readyState) setTimeout(se.ready);
        ...
        se.Callbacks = function(e) {
            var n, i, o, a, s, u, l = [],
                c = !(e = "string" == typeof e ? we[e] || r(e) : se.extend({},
                    e)).once && [],
                f = function(t) {
                ...
                p = {
                    ...
                    remove: function() {
                        return l && se.each(arguments,
                            function(e, t) {
                                for (var r; (r = se.inArray(t, l, r)) > -1;) l.splice(r, 1),
                                n && (a >= r && a--, s >= r && s--)
                            }),
                            this
                    },
            ...
            se.support = function() {
                ...
                try {
                    ...
                    t.deleteExpando = !1
                } (i = V.createElement("input")).setAttribute("value", ""),
                    ...
                    (a = V.createDocumentFragment()).appendChild(i),
                ...
                return f.style.backgroundClip = "content-box",
                    ...
                    se(function() {
                        ...
                        a && (n = V.createElement("div"), n.style.cssText = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px", a.appendChild(n).appendChild(f), f.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", i = f.getElementsByTagName("td"), i[0].style.cssText = "padding:0;margin:0;border:0;display:none", l = 0 === i[0].offsetHeight, i[0].style.display = "", i[1].style.display = "none", t.reliableHiddenOffsets = l && 0 === i[0].offsetHeight, f.innerHTML = "", f.style.cssText = "box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;", t.boxSizing = 4 === f.offsetWidth, t.doesNotIncludeMarginInBodyOffset = 1 !== a.offsetTop, e.getComputedStyle && (t.pixelPosition = "1%" !== (e.getComputedStyle(f, null) || {}).top, t.boxSizingReliable = "4px" === (e.getComputedStyle(f, null) || {
                            width: "4px"
                        }).width, r = f.appendChild(V.createElement("div")), r.style.cssText = f.style.cssText = o, r.style.marginRight = r.style.width = "0", f.style.width = "1px", t.reliableMarginRight = !parseFloat((e.getComputedStyle(r, null) || {}).marginRight)), typeof f.style.zoom !== U && (f.innerHTML = "", f.style.cssText = o + "width:1px;padding:1px;display:inline;zoom:1", t.inlineBlockNeedsLayout = 3 === f.offsetWidth, f.style.display = "block", f.innerHTML = "<div></div>", f.firstChild.style.width = "5px", t.shrinkWrapBlocks = 3 !== f.offsetWidth, t.inlineBlockNeedsLayout && (a.style.zoom = 1)), a.removeChild(n), n = f = i = r = null)
                    }),
                    n = o = a = s = r = i = null,
                    t
            } ();
        ...
        se.fn.extend({
            ...
            toggleClass: function(e, t) {
                ...
                return se.isFunction(e) ? this.each(function(n) {
                    ...
                    else(n === U || "boolean" === n) && (this.className && se._data(this, "__className__", this.className), this.className = this.className || !1 === e ? "": se._data(this, "__className__") || "")
                })
            },
            hasClass: function(e) {
                for (var t = " " + e + " ",
                         n = 0,
                         r = this.length; r > n; n++) if (1 === this[n].nodeType && (" " + this[n].className + " ").replace(Se, " ").indexOf(t) >= 0) return ! 0;
                return ! 1
            },
            val: function(e) {
                var n, r, i, o = this[0];
                return arguments.length ? (i = se.isFunction(e), this.each(function(n) {
                    var o, a = se(this);
                    1 === this.nodeType && (null == (o = i ? e.call(this, n, a.val()) : e) ? o = "": "number" == typeof o ? o += "": se.isArray(o) && (o = se.map(o,
                        function(e) {
                            return null == e ? "": e + ""
            ...
            se.extend({
                    ...
                    select: {
                        get: function(e) {
                            for (var t, n, r = e.options,
                                     ...
                                     a = o ? null: [], s = o ? i + 1 : r.length, u = 0 > i ? s: o ? i: 0; s > u; u++) if (! (! (n = r[u]).selected && u !== i || (se.support.optDisabled ? n.disabled: null !== n.getAttribute("disabled")) || n.parentNode.disabled && se.nodeName(n.parentNode, "optgroup"))) {
                ...
                prop: function(e, n, r) {
                    ...
                    if (e && 3 !== a && 8 !== a && 2 !== a) return (1 !== a || !se.isXMLDoc(e)) && (n = se.propFix[n] || n, o = se.propHooks[n]),
        ...
        se.event = {
            ...
            add: function(e, n, r, i, o) {
                ...
                if (y) {
                    for (r.handler && (l = r, r = l.handler, o = l.selector), r.guid || (r.guid = se.guid++), (s = y.events) || (s = y.events = {}), (f = y.handle) || (f = y.handle = function(e) {
                        ...
                        f.elem = e), u = (n = (n || "").match(le) || [""]).length; u--;) a = $e.exec(n[u]) || [],
                        h = m = a[1],
                        g = (a[2] || "").split(".").sort(),
                        ...
                        p = se.extend({
                            ...
                            l),
                    (d = s[h]) || (d = s[h] = [], d.delegateCount = 0, c.setup && !1 !== c.setup.call(e, i, g, f) || (e.addEventListener ? e.addEventListener(h, f, !1) : e.attachEvent && e.attachEvent("on" + h, f))),
            ...
            remove: function(e, t, n, r, i) {
                ...
                if (m && (c = m.events)) {
                    for (l = (t = (t || "").match(le) || [""]).length; l--;) if (s = $e.exec(t[l]) || [], d = g = s[1], h = (s[2] || "").split(".").sort(), d) {
                        for (f = se.event.special[d] || {},
                                 p = c[d = (r ? f.delegateType: f.bindType) || d] || [], s = s[2] && RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), u = o = p.length; o--;) a = p[o],
            ...
            fix: function(e) {
                ...
                var t, n, r, i = e.type,
                    o = e,
                    a = this.fixHooks[i];
                for (a || (this.fixHooks[i] = a = Oe.test(i) ? this.mouseHooks: Fe.test(i) ? this.keyHooks: {}), r = a.props ? this.props.concat(a.props) : this.props, e = new se.Event(o), t = r.length; t--;) n = r[t],
                    e[n] = o[n];
            ...
            mouseHooks: {
                ...
                filter: function(e, n) {
                    var r, i, o, a = n.button,
                        s = n.fromElement;
                    return null == e.pageX && null != n.clientX && (i = e.target.ownerDocument || V, o = i.documentElement, r = i.body, e.pageX = n.clientX + (o && o.scrollLeft || r && r.scrollLeft || 0) - (o && o.clientLeft || r && r.clientLeft || 0), e.pageY = n.clientY + (o && o.scrollTop || r && r.scrollTop || 0) - (o && o.clientTop || r && r.clientTop || 0)),
        ...
        se.support.changeBubbles || (se.event.special.change = {
            setup: function() {
                return _e.test(this.nodeName) ? (("checkbox" === this.type || "radio" === this.type) && (se.event.add(this, "propertychange._change",
                    function(e) {
                    ...
                    function(e) {
                        var t = e.target;
                        _e.test(t.nodeName) && !se._data(t, "changeBubbles") && (se.event.add(t, "change._change",
        ...
        se.support.focusinBubbles || se.each({
            ...
            function(e, t) {
                ...
                function a(e, t, n, r) {
                    ...
                    if (!L && !r) {
                        if (i = pe.exec(e)) if (a = i[1]) {
                            ...
                            if (i[2]) return J.apply(n, G.call(t.getElementsByTagName(e), 0)),
                                n;
                            if ((a = i[3]) && $.getByClassName && t.getElementsByClassName) return J.apply(n, G.call(t.getElementsByClassName(a), 0)),
                                n
                        }
                        if ($.qsa && !H.test(e)) {
                            if (p = !0, d = O, h = t, g = 9 === s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
                                ...
                                h = ce.test(e) && t.parentNode || t,
                                    g = f.join(",")
                            }
                            if (g) try {
                                return J.apply(n, G.call(h.querySelectorAll(g), 0)),
                                    n
                            } catch(e) {} finally {
                ...
                function s(e, t) {
                    var n = t && e,
                        r = n && (~t.sourceIndex || U) - (~e.sourceIndex || U);
                    if (r) return r;
                ...
                function l(e, t) {
                    ...
                    for (s = e, u = [], l = w.preFilter; s;) { (!n || (r = ie.exec(s))) && (r && (s = s.slice(r[0].length) || s), u.push(i = [])),
                        n = !1,
                    (r = oe.exec(s)) && (n = r.shift(), i.push({
                        value: n,
                        type: r[0].replace(re, " ")
                    }), s = s.slice(n.length));
                ...
                function h(e, t, n, r, o, a) {
                    ...
                    o && !o[O] && (o = h(o, a)),
                        i(function(i, a, s, u) {
                            ...
                            } else b = d(b === a ? b.splice(g, b.length) : b),
                                o ? o(null, a, b, u) : J.apply(a, b)
                        })
                }
                function g(e) {
                    for (var t, n, r, i = e.length,
                             o = w.relative[e[0].type], a = o || w.relative[" "], s = o ? 1 : 0, u = f(function(e) {
                                return e === t
                            },
                            a, !0), l = f(function(e) {
                                return Q.call(t, e) > -1
                        ...
                        }]; i > s; s++) if (n = w.relative[e[s].type]) d = [f(p(d), n)];
                    else {
                    ...
                    var n = 0,
                        ...
                        s = function(i, s, u, l, c) {
                            var f, p, h, g = [],
                                ...
                                b = null != c,
                                x = S,
                                N = i || o && w.find.TAG("*", c && s.parentNode || s),
                                C = P += null == x ? 1 : Math.random() || .1;
                ...
                function v(e, t, n, r) {
                    ...
                    if (!r && 1 === f.length) {
                        ...
                        for (i = le.needsContext.test(e) ? 0 : o.length; i--&&(a = o[i], !w.relative[s = a.type]);) if ((u = w.find[s]) && (r = u(a.matches[0].replace(ye, ve), ce.test(o[0].type) && t.parentNode || t))) {
                            if (o.splice(i, 1), !(e = r.length && c(o))) return J.apply(n, G.call(r, 0)),
                                n;
                            break
                        }
                    }
                    return k(e, f)(r, t, L, n, ce.test(e)),
                        n
                }
                function b() {}
                var x, T, w, N, C, k, E, S, A, j, D, L, H, q, M, _, F, O = "sizzle" + -new Date,
                    B = e.document,
                    $ = {},
                    P = 0,
                    W = 0,
                ...
                C = a.isXML = function(e) {
                    ...
                    A = a.setDocument = function(e) {
                        ...
                        return r !== j && 9 === r.nodeType && r.documentElement ? (j = r, D = r.documentElement, L = C(r), $.tagNameNoComments = o(function(e) {
                            ...
                            return $.getIdNotName = !r.getElementById(O),
                                D.removeChild(e),
                                t
                            ...
                            $.getIdNotName ? (w.find.ID = function(e, t) {
                            ...
                            w.find.NAME = $.getByName &&
                                function(e, n) {
                                    return typeof n.getElementsByName !== X ? n.getElementsByName(name) : t
                                },
                            w.find.CLASS = $.getByClassName &&
                                function(e, n) {
                                    return typeof n.getElementsByClassName === X || L ? t: n.getElementsByClassName(e)
                                },
                            q = [], H = [":focus"], ($.qsa = n(r.querySelectorAll)) && (o(function(e) {
                            e.innerHTML = "<select><option selected=''></option></select>",
                            e.querySelectorAll("[selected]").length || H.push("\\[" + K + "*(?:checked|disabled|ismap|multiple|readonly|selected|value)"),
                            e.querySelectorAll(":checked").length || H.push(":checked")
                        }), o(function(e) {
                            e.innerHTML = "<input type='hidden' i=''/>",
                            e.querySelectorAll("[i^='']").length && H.push("[*^$]=" + K + "*(?:\"\"|'')"),
                            e.querySelectorAll(":enabled").length || H.push(":enabled", ":disabled"),
                                e.querySelectorAll("*,:x"),
                                H.push(",.*:")
                        })), ($.matchesSelector = n(M = D.matchesSelector || D.mozMatchesSelector || D.webkitMatchesSelector || D.oMatchesSelector || D.msMatchesSelector)) && o(function(e) {
                            $.disconnectedMatch = M.call(e, "div"),
                                M.call(e, "[s!='']:x"),
                                q.push("!=", ne)
                        }), H = RegExp(H.join("|")), q = RegExp(q.join("|")), _ = n(D.contains) || D.compareDocumentPosition ?
                            function(e, t) {
                            ...
                            E = !1, [0, 0].sort(F), $.detectDuplicates = E, j) : j
                    },
                    a.matches = function(e, t) {
                        return a(e, null, null, t)
                    },
                    a.matchesSelector = function(e, t) {
                        if ((e.ownerDocument || e) !== j && A(e), t = t.replace(me, "='$1']"), !(!$.matchesSelector || L || q && q.test(t) || H.test(t))) try {
                            var n = M.call(e, t);
                    ...
                    a.attr = function(e, t) {
                        ...
                        return (e.ownerDocument || e) !== j && A(e),
                        L || (t = t.toLowerCase()),
                            (n = w.attrHandle[t]) ? n(e) : L || $.attributes ? e.getAttribute(t) : ((n = e.getAttributeNode(t)) || e.getAttribute(t)) && !0 === e[t] ? t: n && n.specified ? n.value: null
                    },
                    a.error = function(e) {
                    ...
                    a.uniqueSort = function(e) {
                        var t, n = [],
                            r = 1,
                            i = 0;
                        if (E = !$.detectDuplicates, e.sort(F), E) {
                    ...
                    w = a.selectors = {
                        ...
                        filter: {
                                    ...
                                    function(e) {
                                        ...
                                        if (m) {
                                            ...
                                            if (h = [a ? m.firstChild: m.lastChild], a && v) {
                                                for (d = (l = (c = m[O] || (m[O] = {}))[e] || [])[0] === P && l[1], p = l[0] === P && l[2], f = d && m.childNodes[d]; f = ++d && f && f[g] || (p = d = 0) || h.pop();) if (1 === f.nodeType && ++p && f === t) {
                                                    c[e] = [P, d, p];
                                                    break
                                                }
                                            } else if (v && (l = (t[O] || (t[O] = {}))[e]) && l[0] === P) p = l[1];
                                            else for (; (f = ++d && f && f[g] || (p = d = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== y: 1 !== f.nodeType) || !++p || (v && ((f[O] || (f[O] = {}))[e] = [P, p]), f !== t)););
                            ...
                            PSEUDO: function(e, t) {
                                ...
                                return r[O] ? r(t) : r.length > 1 ? (n = [e, e, "", t], w.setFilters.hasOwnProperty(e.toLowerCase()) ? i(function(e, n) {
                                    for (var i, o = r(e, t), a = o.length; a--;) i = Q.call(e, o[a]),
                                        e[i] = !(n[i] = o[a])
                                }) : function(e) {
                                    return r(e, 0, n)
                                }) : r
                        ...
                        pseudos: {
                            ...
                            lang: i(function(e) {
                                return ue.test(e || "") || a.error("unsupported lang: " + e),
                                    e = e.replace(ye, ve).toLowerCase(),
                                    function(t) {
                                        var n;
                                        do {
                ...
                k = a.compile = function(e, t) {
                    ...
                    w.filters = b.prototype = w.pseudos,
                    w.setFilters = new b,
                    A(),
                    a.attr = se.attr,
                    se.find = a,
        ...
        se.fn.extend({
            ...
            closest: function(e, t) {
                for (var n, r = 0,
                         i = this.length,
                         o = [], a = Ie.test(e) || "string" != typeof e ? se(e, t || this.context) : 0; i > r; r++) for (n = this[r]; n && n.ownerDocument && n !== t && 11 !== n.nodeType;) {
        ...
        ot.optgroup = ot.option,
            ...
            se.fn.extend({
                ...
                domManip: function(e, n, r) {
                    ...
                    if (f && (l = se.buildFragment(e, this[0].ownerDocument, !1, this), i = l.firstChild, 1 === l.childNodes.length && (l = i), i)) {
                        for (n = n && se.nodeName(i, "tr"), a = (s = se.map(b(l, "script"), h)).length; f > c; c++) o = l,
                        c !== m && (o = se.clone(o, !0, !0), a && se.merge(s, b(o, "script"))),
                            r.call(n && se.nodeName(this[c], "table") ? d(this[c], "tbody") : this[c], o, c);
                        if (a) for (u = s[s.length - 1].ownerDocument, se.map(s, g), c = 0; a > c; c++) o = s[c],
            ...
            se.extend({
                clone: function(e, t, n) {
                    ...
                    return (r = b(o, "script")).length > 0 && m(r, !u && b(e, "script")),
                        r = s = i = null,
                        o
                },
                buildFragment: function(e, t, n, r) {
                    for (var i, o, a, s, u, l, c, f = e.length,
                             d = p(t), h = [], g = 0; f > g; g++) if ((o = e[g]) || 0 === o) if ("object" === se.type(o)) se.merge(h, o.nodeType ? [o] : o);
                    else if (Ke.test(o)) {
                ...
                cleanData: function(e, t) {
                    for (var n, r, i, o, a = 0,
                             ...
                             c = se.event.special; null != (n = e[a]); a++) if ((t || se.acceptData(n)) && (i = n[s], o = i && u[i])) {
        ...
        se.fn.extend({
            ...
            se.extend({
                ...
                css: function(e, n, r, i) {
                    ...
                    (s = se.cssHooks[n] || se.cssHooks[u]) && "get" in s && (a = s.get(e, !0, r)),
                    a === t && (a = lt(e, n, i)),
                    "normal" === a && n in xt && (a = xt[n]),
                        "" === r || r ? (o = parseFloat(a), !0 === r || se.isNumeric(o) ? o || 0 : a) : a
                },
            ...
            e.getComputedStyle ? (ut = function(t) {
                ...
                lt = function(e, n, r) {
                    ...
                    mt.test(u) && !pt.test(n) && (i = l.left, o = e.runtimeStyle, (a = o && o.left) && (o.left = e.currentStyle.left), l.left = "fontSize" === n ? "1em": u, u = l.pixelLeft + "px", l.left = i, a && (o.left = a)),
                        "" === u ? "auto": u
                }),
        ...
        try {
            jt = Y.href
        } catch(e) { (jt = V.createElement("a")).href = "",
            jt = jt.href
        }
        At = Bt.exec(jt.toLowerCase()) || [],
            se.fn.load = function(e, n, r) {
                ...
                return u >= 0 && (i = e.slice(u, e.length), e = e.slice(0, u)),
                    se.isFunction(n) ? (r = n, n = t) : n && "object" == typeof n && (a = "POST"),
                s.length > 0 && se.ajax({
                    url: e,
                    type: a,
                    dataType: "html",
            ...
            se.extend({
                ...
                ajax: function(e, n) {
                    ...
                    if (g.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, p.url = ((e || p.url || jt) + "").replace(Ht, "").replace(Ot, At[1] + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = se.trim(p.dataType || "*").toLowerCase().match(le) || [""], null == p.crossDomain && (i = Bt.exec(p.url.toLowerCase()), p.crossDomain = !(!i || i[1] === At[1] && i[2] === At[2] && (i[3] || ("http:" === i[1] ? 80 : 443)) == (At[3] || ("http:" === At[1] ? 80 : 443)))), p.data && p.processData && "string" != typeof p.data && (p.data = se.param(p.data, p.traditional)), L(Pt, p, n, w), 2 === x) return w; (l = p.global) && 0 == se.active++&&se.event.trigger("ajaxStart"),
                        p.type = p.type.toUpperCase(),
                        p.hasContent = !Ft.test(p.type),
                        a = p.url,
                    p.hasContent || (p.data && (a = p.url += (Lt.test(a) ? "&": "?") + p.data, delete p.data), !1 === p.cache && (p.url = qt.test(a) ? a.replace(qt, "$1_=" + Dt++) : a + (Lt.test(a) ? "&": "?") + "_=" + Dt++)),
                    p.ifModified && (se.lastModified[a] && w.setRequestHeader("If-Modified-Since", se.lastModified[a]), se.etag[a] && w.setRequestHeader("If-None-Match", se.etag[a])),
            ...
            se.ajaxTransport("script",
                function(e) {
                    if (e.crossDomain) {
                        ...
                        return {
                            send: function(t, i) { (n = V.createElement("script")).async = !0,
        ...
        se.ajaxSetup({
            ...
            se.ajaxPrefilter("json jsonp",
                function(n, r, i) {
                    ...
                    return u || "jsonp" === n.dataTypes[0] ? (o = n.jsonpCallback = se.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback, u ? n[u] = n[u].replace(zt, "$1" + o) : !1 !== n.jsonp && (n.url += (Lt.test(n.url) ? "&": "?") + n.jsonp + "=" + o), n.converters["script json"] = function() {
        ...
        (Ut = se.support.ajax = !!Ut) && se.ajaxTransport(function(n) {
        ...
        var Jt, Gt, Qt = /^(?:toggle|show|hide)$/,
            ...
            en = [function(e, t, n) {
                ...
                n.overflow && (d.overflow = "hidden", se.support.shrinkWrapBlocks || p.always(function() {
                    d.overflow = n.overflow[0],
                        d.overflowX = n.overflow[1],
                        d.overflowY = n.overflow[2]
                }));
                for (i in t) if (a = t[i], Qt.exec(a)) {
                    if (delete t[i], u = u || "toggle" === a, a === (m ? "hide": "show")) continue;
                    g.push(i)
                }
                if (o = g.length) {
                    "hidden" in (s = se._data(e, "fxshow") || se._data(e, "fxshow", {})) && (m = s.hidden),
                    u && (s.hidden = !m),
        ...
        se.Animation = se.extend($, {
            ...
            se.fx.tick = function() {
                var e, n = se.timers,
                    r = 0;
                for (Jt = se.now(); n.length > r; r++)(e = n[r])() || n[r] !== e || n.splice(r--, 1);
                n.length || se.fx.stop(),
                    Jt = t
            },
            ...
            se.offset = {
                setOffset: function(e, t, n) {
                    ...
                    var i, o, a = se(e),
                        ...
                        l = se.css(e, "left"),
                        c = {},
                        f = {}; ("absolute" === r || "fixed" === r) && se.inArray("auto", [u, l]) > -1 ? (f = a.position(), i = f.top, o = f.left) : (i = parseFloat(u) || 0, o = parseFloat(l) || 0),
    ...
    function() {
        ...
        $("#bNav1 a").css("padding-top", ((e - 75) / 5 - 60) / 2 + "px"),
            $("#bNav1 a").css("padding-bottom", ((e - 75) / 5 - 60) / 2 + "px"),
            $(".content").css("height", e - 110),
            $(".salingBox .content").css("height", e - 95),
            $(".content table").attr("data-height", e - 140),
            $(".content .listBox").attr("data-height", e - 140),
            $(".contentT table").attr("data-height", e - 180),
            $("#aWaitPassUser").css("height", e - 160),
            $("#contentTable").css("height", e - 110),
            $(".modal-body").css("max-height", e - 220),
